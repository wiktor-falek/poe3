...
class WeaponBase extends GearBase_1.default {
    constructor(name, ilvl, requirements, baseMods, implicits) {
        ...
        _WeaponBase_PREFIX_MODIFIER_POOL.set(this, (0, utils_1.deepFreeze)([
        ...
        _WeaponBase_SUFFIX_MODIFIER_POOL.set(this, (0, utils_1.deepFreeze)([
    ...
    magic() {
        return super.magic(__classPrivateFieldGet(this, _WeaponBase_PREFIX_MODIFIER_POOL, "f"), __classPrivateFieldGet(this, _WeaponBase_SUFFIX_MODIFIER_POOL, "f"));
    }
}
