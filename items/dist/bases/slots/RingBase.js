...
class RingBase extends GearBase_1.default {
    constructor(name, ilvl, requirements, baseMods, implicits) {
        ...
        _RingBase_PREFIX_MODIFIER_POOL.set(this, [
        ...
        _RingBase_SUFFIX_MODIFIER_POOL.set(this, [
    ...
    normalToMagicRarity() {
        return super.normalToMagicRarity(__classPrivateFieldGet(this, _RingBase_PREFIX_MODIFIER_POOL, "f"), __classPrivateFieldGet(this, _RingBase_SUFFIX_MODIFIER_POOL, "f"));
    }
}
